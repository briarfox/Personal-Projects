...
class FoscamCamera(object):
    ...
    def startVideo(self, callback=None, userdata=None):
        if not self.isPlaying():
            ...
            self.videothread = Thread(target=findFrame, args=(self, f, callback, userdata))
            self.setIsPlaying(1)
...
if __name__ == '__main__':
    ...
    TESTURL = 'houserip.dyndns.tv:8091'

    print
    print 'testing the Foscam camera code'
    print
    
    foscam = FoscamCamera(TESTURL, user='chouser56', pwd='i43kr13t1n')
    '''
